...
const startAppAgain = async () => {
  const answerAgain = await inquirer.prompt([
    {
      name: 'startAgain',
      message: 'Do you want to add a watermark to your next file?',
      type: 'confirm'
    }
  ]);

  if (!answerAgain.startAgain) {
    console.log('Hope see you soon');
    process.exit();
  } else {
    startApp();
  }
